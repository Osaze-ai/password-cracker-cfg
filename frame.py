...
#Function to read url text file of the 10,000 most common passwords which will be used a dictionary
...
def compare_passwords():
    ...
    #Follow this path
        ...
        messagebox.showerror(title="Crack unsuccessful", message="Finding another way..")#pop up box which shows invalid login needs to change to password cracker 
